...
if (app.documents.length > 0) {  
    ...
    var width = Number(Window.prompt ("Enter New Artboard Width in points", 500, title));  
    var height = Number(Window.prompt ("Enter New Artboard Height in points", 100, title));  
