...
(function() {
    ...
    function processBatchReplacement(sourceComp, sourceLayerName, footageDir, fileFilter, namingOption, addToRenderQueue) {
        ...
        // Create a new folder for the duplicated comps
        var outputFolder = app.project.items.addFolder("Batch Output - " + new Date().toLocaleString());
        ...
        alert("Created " + createdComps.length + " compositions with replaced footage.");
